...
const Modes = [
    {
        ...
        text: "General",
        percent: "10%",
        lightMode: "bg-indigo-50 text-indigo-800 border-indigo-200 hover:bg-indigo-100/80",
        darkMode: "bg-indigo-900/20 text-indigo-100 border-indigo-700 hover:bg-indigo-900/30",
    ...
    },
    {
        ...
        text: "Productivity",
        percent: "5%",
        lightMode: "bg-teal-50 text-teal-800 border-teal-200 hover:bg-teal-100/80",
        darkMode: "bg-teal-900/20 text-teal-100 border-teal-700 hover:bg-teal-900/30",
        ...
        text: "Wellness",
        percent: "8%",
        lightMode: "bg-rose-50 text-rose-800 border-rose-200 hover:bg-rose-100/80",
        darkMode: "bg-rose-900/20 text-rose-100 border-rose-700 hover:bg-rose-900/30",
        ...
        text: "Learning",
        percent: "13%",
        lightMode: "bg-blue-50 text-blue-800 border-blue-200 hover:bg-blue-100/80",
        darkMode: "bg-blue-900/20 text-blue-100 border-blue-700 hover:bg-blue-900/30",
        ...
        text: "Creative",
        percent: "15%",
        lightMode: "bg-amber-50 text-amber-800 border-amber-200 hover:bg-amber-100/80",
        darkMode: "bg-amber-900/20 text-amber-100 border-amber-700 hover:bg-amber-900/30",
        ...
        text: "BFF",
        percent: "0%",
        lightMode: "bg-purple-50 text-purple-800 border-purple-200 hover:bg-purple-100/80",
        darkMode: "bg-purple-900/20 text-purple-100 border-purple-700 hover:bg-purple-900/30",
